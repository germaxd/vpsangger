...
data_ip="https://raw.githubusercontent.com/germaxd/permission/main/seler"
checking_sc() {
...
echo -e "         $COLOR1         ${WH}Telegram: t.me/germatunnel    ${NC}"
echo -e "         $COLOR1      ${WH}Whatsapp: wa.me/62895704360033    ${NC}"
echo -e "         $COLOR1╰══════════════════════════════════════════╯${NC}"
...
checking_sc
clear
Repo1="https://raw.githubusercontent.com/germaxd/permission/main/"
...
REPO="https://github.com/germaxd/permission.git"
EMAIL="jbb.zyrex@gmail.com"
USER="germaxd"
...
URL="https://api.telegram.org/bot$KEY/sendMessage"
    ...
    git remote add origin https://github.com/germaxd/permission
    git push -f https://${TOKEN}@github.com/germaxd/permission.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
