...
clear;clear;clear
echo -e "${BIBlue}╭══════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│ ${BGCOLOR} WELCOME TO GERMA TUNNEL             ${BIBlue} │${NC}"
echo -e "${BIBlue}╰══════════════════════════════════════════╯${NC}"
echo ""
sleep 4
clear
...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/germaxd/permission/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/germaxd/permission/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
Exp1=$(curl https://raw.githubusercontent.com/germaxd/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/germaxd/vpsangger/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/germaxd/permission/main/ip | grep $ipsaya | awk '{print $2}')
EXPSC=$(wget -qO- https://raw.githubusercontent.com/germaxd/permission/main/ip | grep $ipsaya | awk '{print $3}')
...
wget https://raw.githubusercontent.com/germaxd/vpsangger/main/Fls/limit.sh && chmod +x limit.sh && ./limit.sh
cd
...
wget -O /usr/bin/ws "https://raw.githubusercontent.com/germaxd/vpsangger/main/Fls/ws" >/dev/null 2>&1
wget -O /usr/bin/tun.conf "https://raw.githubusercontent.com/germaxd/vpsangger/main/Cfg/tun.conf" >/dev/null 2>&1
wget -O /etc/systemd/system/ws.service "https://raw.githubusercontent.com/germaxd/vpsangger/main/Fls/ws.service" >/dev/null 2>&1
...
wget https://raw.githubusercontent.com/germaxd/vpsangger/main/menu/menu.zip
wget -q -O /usr/bin/enc "https://raw.githubusercontent.com/germaxd/vpsangger/main/Enc/encrypt" ; chmod +x /usr/bin/enc
unzip menu.zip
chmod +x menu/*
...
clear
echo -e "${BIBlue}╭════════════════════════════════════════════════════╮${NC}"
echo -e "${BIBlue}│${BGCOLOR} SUCCESS INSTALL AUTOSCRIPT PREMIUM BY GERMA TUNNEL${NC} ${BIBlue}│${NC}"
echo -e "${BIBlue}╰════════════════════════════════════════════════════╯${NC}"
echo -e ""
